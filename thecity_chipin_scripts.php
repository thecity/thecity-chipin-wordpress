...
function thecity_chipin_wordpress_scripts() {    
  ...
  wp_enqueue_script('formatter_city_style_js', plugins_url('/scripts/formatter_city_style.js', __FILE__));  
}
...
function thecity_chipin_wordpress_styles() {  
  ...
  wp_enqueue_style('formatter_city_style_css', plugins_url( '/scripts/formatter_city_style.css', __FILE__));  
}
